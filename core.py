...
async def on_message(message):
    ...
    if mensagem.split(" ")[0] == "help":
        ...
        await message.channel.send(".  Exemplo: <O que é isso?")
        sleep(0.2)
        await message.channel.send("E anexado com a mensagem, a imagem do objeto.")
        await message.channel.send("Esteja ciente que ele foi treinado para classificar imagens de objetos como: __Chave-Inglesa, Tesoura, e Vassoura__.")
        sleep(0.2)
